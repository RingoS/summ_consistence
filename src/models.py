...
class BertForTokenClassification_modified(modeling_bert.BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
# made new version on 2020/June/03
class EncoderDecoderInsertionModel_original(PreTrainedModel):
    r"""
        :class:`~transformers.EncoderDecoder` is a generic model class that will be
        instantiated as a transformer architecture with one of the base model
        classes of the library as encoder and another one as
